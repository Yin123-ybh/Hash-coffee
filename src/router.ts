  ...
  routes: [
    {
      ...
      meta: { title: 'Hash咖啡', hidden: true, notNeedAuth: true }
    },
    {
      path: '/404',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'coupon',
          component: () =>
            import(/* webpackChunkName: "coupon" */ '@/views/coupon/template/index.vue'),
          meta: {
            title: '优惠券管理',
            icon: 'icon-coupon-template'
          }
        },
        {
          path: 'seckill',
          component: () =>
            import(/* webpackChunkName: "coupon" */ '@/views/coupon/seckill/index.vue'),
          meta: {
            title: '秒杀活动',
            icon: 'icon-seckill-activity'
          }
        },
        {
          path: 'coupon-statistics',
          component: () =>
            import(/* webpackChunkName: "coupon" */ '@/views/coupon/statistics/index.vue'),
          meta: {
            title: '优惠券统计',
            icon: 'icon-coupon-statistics'
          }
        }
      ]
    },
