...
public class SeckillActivityController {
    ...
    @PostMapping
    @ApiOperation("新增秒杀活动")
    public Result save(@RequestBody SeckillActivityDTO seckillActivityDTO) {
    ...
    @PutMapping
    @ApiOperation("修改秒杀活动")
    public Result update(@RequestBody SeckillActivityDTO seckillActivityDTO) {
    ...
    @ApiOperation("增加已售数量")
    public Result increaseSoldCount(@PathVariable Long id, @RequestParam Integer quantity) {
